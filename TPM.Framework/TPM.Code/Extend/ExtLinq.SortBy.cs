...
namespace TPM.Code
{
    public static partial class ExtLinq
    {
        ...
        {
            return InvokeSortBy(query, sortPredicate, "asc");
        }
        ...
        private static IOrderedQueryable<TEntity> InvokeSortBy<TEntity>(IQueryable<TEntity> query,
            Expression<Func<TEntity, dynamic>> sortPredicate, String sortOrder)
            where TEntity : class, new()
        {
        ...
        private static string GetSortingMethodName(String sortOrder)
        {
